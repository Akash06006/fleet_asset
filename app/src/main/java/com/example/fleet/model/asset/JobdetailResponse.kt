...
class JobdetailResponse {
    ...
    inner class AssignWarehouse {
        ...
        @Expose
        var fromWarehouse : FromWarehouse? = null

        @SerializedName("ToWarehouse")
        @Expose
        var toWarehouse : ToWarehouse? = null

        @SerializedName("wareHouse")
        @Expose
        var wareHouse : WareHouse? = null
        @SerializedName("wareHousePolyline")
        @Expose
        var wareHousePolyline : WareHousePolyline? = null
        ...
        inner class FromWarehouse {
            ...
            @Expose
            var id : String? = null
            @SerializedName("wareAddress")
            @Expose
            var wareAddress : String? = null
            @SerializedName("wareLatitude")
            @Expose
            var wareLatitude : String? = null

        }
        inner class ToWarehouse {
            @SerializedName("wareName")
            @Expose
            var wareName : String? = null
            @SerializedName("id")
        ...
        inner class WareHousePolyline{
            ...
            @SerializedName("wareHouseImageId")
            @Expose
            var wareHouseImageId : String? = null
            @SerializedName("wareHouseId")
            @Expose
            var wareHouseId : String? = null

           // @SerializedName("warePolyCordinates")
           // @Expose
           // var warePolyCordinates : ArrayList<WarePolyCordinates>? = null

           /* inner class WarePolyCordinates{
                @SerializedName("lat")
                @Expose
                var lat : String? = null
                @SerializedName("long")
